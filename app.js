...
import conversacionRoutes  from './routes/conversacionRoutes.js';   // ← NUEVO
...
app.get('/api/health', (req, res) => {
  res.json({ ok: true, mensaje: 'Servidor activo ✅', version: '1.2.0', timestamp: new Date().toISOString() });
});
...
app.use('/api/conversaciones',  conversacionRoutes);   // ← NUEVO
...
server.listen(PORT, () => {
  ...
  console.log(`💬 Chat directo habilitado`);
